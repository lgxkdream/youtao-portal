...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://www.taotao.com/"><img clstag="clickcart|keycount|xincart|logo" src="/images/taotao-logo.gif" title="返回优淘商城首页" alt="返回优淘商城首页"></a></div>
