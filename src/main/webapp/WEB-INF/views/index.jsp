...
<title>优淘网上商城-综合网购首选（YOUTAO.COM）-正品低价、品质保障、货到付款、配送及时、放心服务、轻松购物！</title>
<meta name="description" content="优淘JD.COM-专业的综合网上购物商城，在线销售家电、数码通讯、电脑、家居百货、服装服饰、母婴、图书、食品、在线旅游等数万个品牌千万种优质商品。便捷、诚信的服务，为您提供愉悦的网上商城购物体验! ">
<meta name="Keywords" content="网上购物,网上商城,手机,笔记本,电脑,MP3,CD,VCD,DV,相机,数码,配件,手表,存储卡,优淘商城">
...
<div class="sm sm2 fore1 curr"  data-widget="tab-item" data-tag="62" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>大家电</h3>
  </div>
...
<div class="sm sm2 fore2"  data-widget="tab-item" data-tag="63" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>大家电 New</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore3"  data-widget="tab-item" data-tag="64" clstag="homepage|keycount|home2013|18e">
  <div class="smt">
    <h3>小家电</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore4"  data-widget="tab-item" data-tag="65" clstag="homepage|keycount|home2013|18f">
  <div class="smt">
    <h3>手机通讯</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore5"  data-widget="tab-item" data-tag="66" clstag="homepage|keycount|home2013|18g">
  <div class="smt">
    <h3>汽车五金</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
<!-- 绑定显示数据到页面 -->
<script type="text/javascript">
pageConfig.DATA_Tabs = ${floorAadvertisement2}</script>
<script type="text/javascript">
